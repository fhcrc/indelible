...
vector<string> MAKEmyCALletters(int partition, int taxon)
{
	...
	if (s == "A") {
	    ...
	    cout << "GENETIC CODE ERROR IN MAKEmyCALletters()" << endl;
	}
	output.push_back(s);
    }     //cout<<s<<endl;}
...
//	cout<<endl<<"4 "<<(sums.CIsums1).size()<<endl;
	...
	y += (sums.IIsums1).at(i);
	z += (sums.ISsums1).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                                                     /*(sums.IDsums10).push_back(x); x=0;		  */
	    (sums.IIsums10).push_back(y);
	    y = 0;
	    (sums.ISsums10).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums10).size() - 1;
    for (i = 0; i < size + 1; i++) {                                            /*x+=(sums.IDsums10).at(i);			*/
	y += (sums.IIsums10).at(i);
	z += (sums.ISsums10).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                                             /*(sums.IDsums100).push_back(x); x=0;		  */
	    (sums.IIsums100).push_back(y);
	    y = 0;
	    (sums.ISsums100).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums100).size() - 1;
    for (i = 0; i < size + 1; i++) {                                            /*x+=(sums.IDsums100).at(i);		*/
	y += (sums.IIsums100).at(i);
	z += (sums.ISsums100).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                                     /*(sums.IDsums1000).push_back(x); x=0;		  */
	    (sums.IIsums1000).push_back(y);
	    y = 0;
	    (sums.ISsums1000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums1000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                        /*x+=(sums.IDsums1000).at(i);		*/
	y += (sums.IIsums1000).at(i);
	z += (sums.ISsums1000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                                     /*(sums.IDsums10000).push_back(x); x=0;		  */
	    (sums.IIsums10000).push_back(y);
	    y = 0;
	    (sums.ISsums10000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums10000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                            /*x+=(sums.IDsums10000).at(i);		*/
	y += (sums.IIsums10000).at(i);
	z += (sums.ISsums10000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                             /*(sums.IDsums100000).push_back(x); x=0;	  */
	    (sums.IIsums100000).push_back(y);
	    y = 0;
	    (sums.ISsums100000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums100000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                            /*x+=(sums.IDsums100000).at(i);		*/
	y += (sums.IIsums100000).at(i);
	z += (sums.ISsums100000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                             /*(sums.IDsums1000000).push_back(x); x=0;	  */
	    (sums.IIsums1000000).push_back(y);
	    y = 0;
	    (sums.ISsums1000000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums1000000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                            /*x+=(sums.IDsums1000000).at(i);	*/
	y += (sums.IIsums1000000).at(i);
	z += (sums.ISsums1000000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                             /*(sums.IDsums10000000).push_back(x); x=0;	  */
	    (sums.IIsums10000000).push_back(y);
	    y = 0;
	    (sums.ISsums10000000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums10000000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                    /*x+=(sums.IDsums10000000).at(i);	*/
	y += (sums.IIsums10000000).at(i);
	z += (sums.ISsums10000000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                     /*(sums.IDsums100000000).push_back(x); x=0;	  */
	    (sums.IIsums100000000).push_back(y);
	    y = 0;
	    (sums.ISsums100000000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums100000000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                    /*x+=(sums.IDsums100000000).at(i);	*/
	y += (sums.IIsums100000000).at(i);
	z += (sums.ISsums100000000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                                     /*(sums.IDsums1000000000).push_back(x); x=0;  */
	    (sums.IIsums1000000000).push_back(y);
	    y = 0;
	    (sums.ISsums1000000000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums1000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                    /*x+=(sums.IDsums1000000000).at(i);	*/
	y += (sums.IIsums1000000000).at(i);
	z += (sums.ISsums1000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                             /*(sums.IDsums10000000000).push_back(x); x=0; */
	    (sums.IIsums10000000000).push_back(y);
	    y = 0;
	    (sums.ISsums10000000000).push_back(z);
	    z = 0;
	}
    }
    size = (sums.ISsums10000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {                                    /*x+=(sums.IDsums10000000000).at(i);*/
	y += (sums.IIsums10000000000).at(i);
	z += (sums.ISsums10000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {                                                                                                                                                                             /*(sums.IDsums).push_back(x);               */
	    (sums.IIsums).push_back(y);
	    (sums.ISsums).push_back(z); /*(rates.insdeleterate)+=x;  (rates.insinsertrate)+=y;*/ (rates.inslength) += y;
	    (rates.inssubrate) += z;
	    x = 0;
	    y = 0;
	    z = 0;
...
//		cout<<"           QWE 2"<<endl;
    ...
    size = (sums.IIsums1000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.IIsums1000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.IIsums10000000).push_back(y);
    ...
    size = (sums.IIsums10000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.IIsums10000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.IIsums100000000).push_back(y);
    ...
    size = (sums.IIsums100000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.IIsums100000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.IIsums1000000000).push_back(y);
    ...
    size = (sums.IIsums1000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.IIsums1000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.IIsums10000000000).push_back(y);
    ...
    size = (sums.IIsums10000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.IIsums10000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.IIsums).push_back(y);
...
//		cout<<"           QWE 3"<<endl;
    ...
    size = (sums.CIsums1000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.CIsums1000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.CIsums10000000).push_back(y);
    ...
    size = (sums.CIsums10000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.CIsums10000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.CIsums100000000).push_back(y);
    ...
    size = (sums.CIsums100000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.CIsums100000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.CIsums1000000000).push_back(y);
    ...
    size = (sums.CIsums1000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.CIsums1000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.CIsums10000000000).push_back(y);
    ...
    size = (sums.CIsums10000000000).size() - 1;
    for (i = 0; i < size + 1; i++) {
	y += (sums.CIsums10000000000).at(i);
	if ((i % 10 == 9) || (i == size)) {
	    (sums.CIsums).push_back(y);
...
// substitution in inserted sites
    ...
    if (pos1000000000 == -1) {
	cout << "1 ERROR in findpos at event " << event << "  unirand-S-s = " << setprecision(20) << unirand - S - s << "  " << unirand << "  " << S << "  " << s << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums1000000000).size(); i++) {
	s = (sum.ISsums1000000000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000000 = i;
    ...
    if (pos100000000 == -1) {
	cout << "2 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums100000000).size(); i++) {
	s = (sum.ISsums100000000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000000 = i;
    ...
    if (pos10000000 == -1) {
	cout << "3 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums10000000).size(); i++) {
	s = (sum.ISsums10000000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000000 = i;
    ...
    if (pos1000000 == -1) {
	cout << "4 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums1000000).size(); i++) {
	s = (sum.ISsums1000000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000 = i;
    ...
    if (pos100000 == -1) {
	cout << "5 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums100000).size(); i++) {
	s = (sum.ISsums100000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000 = i;
    ...
    if (pos10000 == -1) {
	cout << "6 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums10000).size(); i++) {
	s = (sum.ISsums10000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000 = i;
    ...
    if (pos1000 == -1) {
	cout << "7 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums1000).size(); i++) {
	s = (sum.ISsums1000).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100 = i;
    ...
    if (pos100 == -1) {
	cout << "8 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums100).size(); i++) {
	s = (sum.ISsums100).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10 = i;
    ...
    if (pos10 == -1) {
	cout << "9 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums10).size(); i++) {
	s = (sum.ISsums10).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
    ...
    if (pos1 == -1) {
	cout << "10 ERROR in findpos at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.ISsums1).size(); i++) {
	s = (sum.ISsums1).at(i);
	if (unirand <= s + S) {
	    j = 10 * i;
	    updatepositions.push_back(i);
    ...
    if (pos == -1) {
	cout << "11 ERROR in findpos at event " << event << endl;
	return -1;
    }
	...
	cout << "CHOOSING ERROR IN FINDPOS 1" << endl;
    }
...
int findpos0(int event, vector<int>& updatepositions, double unirand, SUMS& sum, double& S)
{
    ...
    if (pos1000000000 == -1) {
	cout << "ERROR in findpos at event " << event << endl;
	return -1;
    }
...
int findpos24(int event, vector<int>& updatepositions, int mypos, SUMS& sum, int& SI)
{
    ...
    if (pos1000000000 == -1) {
	cout << "ERROR in findpos1 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums1000000000).size(); i++) {
	si = (sum.CIsums1000000000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000000 = i;
    ...
    if (pos100000000 == -1) {
	cout << "ERROR in findpos2 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums100000000).size(); i++) {
	si = (sum.CIsums100000000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000000 = i;
    ...
    if (pos10000000 == -1) {
	cout << "ERROR in findpos3 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums10000000).size(); i++) {
	si = (sum.CIsums10000000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000000 = i;
    ...
    if (pos1000000 == -1) {
	cout << "ERROR in findpos4 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums1000000).size(); i++) {
	si = (sum.CIsums1000000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000 = i;
    ...
    if (pos100000 == -1) {
	cout << "ERROR in findpos5 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums100000).size(); i++) {
	si = (sum.CIsums100000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000 = i;
    ...
    if (pos10000 == -1) {
	cout << "ERROR in findpos6 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums10000).size(); i++) {
	si = (sum.CIsums10000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000 = i;
    ...
    if (pos1000 == -1) {
	cout << "ERROR in findpos7 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums1000).size(); i++) {
	si = (sum.CIsums1000).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100 = i;
    ...
    if (pos100 == -1) {
	cout << "ERROR in findpos8 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums100).size(); i++) {
	si = (sum.CIsums100).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10 = i;
    ...
    if (pos10 == -1) {
	cout << "ERROR in findpos9 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums10).size(); i++) {
	si = (sum.CIsums10).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1 = i;
    ...
    if (pos1 == -1) {
	cout << "ERROR in findpos10 at event " << event << endl;
	return -1;
    }
    for (i = j; i < (sum.CIsums1).size(); i++) {
	si = (sum.CIsums1).at(i);
	if (mypos <= si + SI) {
	    j = 10 * i;
	    updatepositions.push_back(i);
    ...
    if (pos == -1) {
	cout << "ERROR in findpos11 at event " << event << endl;
	return -1;
    }
...
int findpos35(int event, vector<int>& updatepositions, int mypos, SUMS& sum, int& SI)
{
    ...
    for (i = j; i < (sum.IIsums1000000000).size(); i++) {
	si = (sum.IIsums1000000000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000000 = i;
    ...
    for (i = j; i < (sum.IIsums100000000).size(); i++) {
	si = (sum.IIsums100000000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000000 = i;
    ...
    for (i = j; i < (sum.IIsums10000000).size(); i++) {
	si = (sum.IIsums10000000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000000 = i;
    ...
    for (i = j; i < (sum.IIsums1000000).size(); i++) {
	si = (sum.IIsums1000000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100000 = i;
    ...
    for (i = j; i < (sum.IIsums100000).size(); i++) {
	si = (sum.IIsums100000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10000 = i;
    ...
    for (i = j; i < (sum.IIsums10000).size(); i++) {
	si = (sum.IIsums10000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1000 = i;
    ...
    for (i = j; i < (sum.IIsums1000).size(); i++) {
	si = (sum.IIsums1000).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos100 = i;
    ...
    for (i = j; i < (sum.IIsums100).size(); i++) {
	si = (sum.IIsums100).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos10 = i;
    ...
    for (i = j; i < (sum.IIsums10).size(); i++) {
	si = (sum.IIsums10).at(i);
	if ((mypos <= si + SI) && (si + SI != 0)) {
	    j = 10 * i;
	    updatepositions.push_back(i);
	    pos1 = i;
...
int chooseevent(RATES& rates)
{
	...
	cout << "ERROR IN CHOOSEEVENT - random number was " << rand << "  and rates.totalrate was " << rates.totalrate << " and temprate was " << temprate << endl;
	return -1;
    }
}
...
//	cout<<"NEW BRANCH"<<endl;
    ...
    if (mytest) {
	cout << "MYTEST checkingindelsubs is on" << endl;
    }
#endif
...
//		if(event!=0) cout<<"WO WO WO "<<event<<endl;
	...
	if (event > 1) {
...
#ifdef checkingindelsubs1
	    if (mytest) {
		indellength = rates.partitionlength;
	    }
#endif
#ifdef checkingindelsubs2
	    if (mytest) {
		...
		insertiontotlength += indellength;
	    }                                                                                                                                   //length of insertion
	    else {
...
//			deletiontotlength+=indellength;
		...
		while (blahrand == 1) {
		    blahrand = mtrand1();
		    intrand  = int((rates.inslength) * blahrand );
		}                                                                                                 // if(globalthisrep==327) cout<<"blahrand "<<blahrand<<"  rates.inslength "<<rates.inslength<<"  x "<<(rates.inslength)*blahrand <<"  intrand "<<intrand<<endl;}
...
#ifdef checkingindelsubs2
	    if (mytest) {
		cout << "NOW NOW " << newseqINT.size() << endl;
		for (int p = 0; p < newseqINT.size(); p++) {
		    intrand = p; /*if(p%100==0) cout<<"P "<<p<<endl;*/ currentev = findpos24(event, updatepositions, intrand, sums, sumreached);
#endif
#ifdef checkingindelsubs3
	    if (mytest) {
		for (int p = 0; p < newseqINT.size(); p++) {
		...
		for (int kp = 0; kp < (sums.CIsums1).size(); kp++) {
		    cout << (sums.CIsums1).at(kp) << " ";
		}
		cout << "blah" << endl;
		for (int kq = 0; kq < (sums.CIsums1).size(); kq++) {
		    cout << newseqINT.at(kq) << " ";
		}
		cout << "blah" << endl;
		cout << endl << ")))))))))))))))))))))))))))))))))" << endl;
	    }
...
/////////////////////
...
#else
    vector<site> insertseq;
    (insINT.at(0)).push_back(insert(insertseq, 0, 0));
    (insPOS.at(0)).push_back(-1);



    int num = int(  double(rates.rootlength - 1) / double(10));

    for (int yg = 0; yg < num; yg++) {
	(sequencesINT.at(0)).push_back(-1);
    }
    ...
    rates.corelength = 1;
    rates.rootlength = rates.partitionlength = num;
    rates.inslength  = 10 * num;
...
int check_indeldistributions()
{
	...
	means.push_back(double(mean) / double(total));
	means2.push_back((*m).delmeansize);
	finish = clock();
	...
	for (int j = 0; j < lines.size(); j++) {
	    (lines.at(j)).push_back(double(counts.at(j)) / double(total));
	}
...
// these are used when checking that substitution works in inserted sites
	    ...
	    if (reps > 1) {
		cout << "  * Block " << blocknumber << " - Replicate " << thisrep << " completed." << endl;
	    }
#endif
